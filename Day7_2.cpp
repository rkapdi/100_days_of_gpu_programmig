/*
* Exercise 3: Create two shader programs where the second program uses a different fragment shader
that outputs the color yellow
*/
...
//my fragment shader for yellow color
const char* fragmentShaderSource_YELLOW = "#version 330 core\n"
"out vec4 FragColor_Yellow;\n"
"void main()\n"
"{\n"
"   FragColor_Yellow = vec4(1.0f, 1.0f, 0.0f, 1.0f);\n"
"}\n\0";
...
int main()
{
    ...
    glShaderSource(fragmentShader_Y, 1, &fragmentShaderSource_YELLOW, NULL);
    ...
    //making vao and vbo for next triangle
    ...
    while (!glfwWindowShouldClose(window))
    {
        ...
        // render
        // ------
        glClearColor(0.05f, 0.30f, 0.0f, 1.0f);//background color
